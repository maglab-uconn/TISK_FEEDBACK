...
def Phoneme_Activation_with_Noise(model, phoneme_List, pronunciation = "l^kS^ri", check_Location_List = [0, 3, 6], prefix=""):
    ...
    extract_Data = [];
    extract_Data.append("\t".join(["Location","Noise", "Cycle", "Activation"]));    
    for location in check_Location_List:
...
if __name__ == "__main__":
    ...
    #Phoneme restoration
    Phoneme_Activation_with_Noise(feedback_TISK, feedback_TISK.phoneme_List, pronunciation = "l^kS^ri", check_Location_List = [0, 3, 6], prefix="Feedback")
    Phoneme_Activation_with_Noise(no_Feedback_TISK, no_Feedback_TISK.phoneme_List, pronunciation = "l^kS^ri", check_Location_List = [0, 3, 6], prefix="No_Feedback")
    Phoneme_Activation_with_Noise(original_TISK, original_TISK.phoneme_List, pronunciation = "l^kS^ri", check_Location_List = [0, 3, 6], prefix="Original")
