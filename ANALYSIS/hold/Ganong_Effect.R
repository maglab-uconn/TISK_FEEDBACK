...
melt_Ganong_Result.Subset <- melt_Ganong_Result.Subset %>%
  mutate(
    Word_Phoneme = case_when(
      ...
      Word_Phoneme == "s | bus" ~ "s | b^",
      Word_Phoneme == "S | bus" ~ "∫ | b^",
      Word_Phoneme == "s | rush" ~ "s | r^",
      Word_Phoneme == "S | rush" ~ "∫ | r^",
...
custom_linetypes <- c("s | b^" = "solid", "∫ | b^" = "solid", "s | r^" = "solid", "∫ | r^" = "solid")
custom_colors <- c("s | b^" = "darkred", "∫ | b^" = "darkblue", "s | r^" = "red", "∫ | r^" = "blue")
custom_shapes <- c("s | b^" = 1, "∫ | b^" = 2, "s | r^" = 21, "∫ | r^" = 25)
